      ...
      <div className="max-w-4xl mx-auto space-y-6 animate-fade-in relative z-10">
        ...
        {loading ? (
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <Skeleton key={i} height={100} radius="md" animate />
            ))}
          </div>
        ) : history.length === 0 ? (
          <div className="card glass p-16 text-center border-dashed border-2 border-dark-border py-24">
            <h3 className="font-bold text-xl mb-2 text-[var(--text)]">
            ...
            {history.map((req) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-[var(--text)] capitalize text-lg tracking-tight mb-1">
                      {req.service.replace("-", " ")}
                    </h3>
                ...
                <div className="flex items-center gap-6">
                  <div className="text-right">
                    ...
                    <div className="font-mono text-[var(--text)] text-lg font-bold">
                      Rs.{req.price || 0}
                    </div>
                  </div>
                </div>
